...
package jsr166.java.util.concurrent;
        import java.util.*;

        import jsr166.java.util.*;
 ...
 * @since 1.6
 */
public class ConcurrentSkipListMap<K,V> extends jsr166.java.util.AbstractMap<K,V>
    ...
    static final class Node<K,V> {
         ...
         */
        jsr166.java.util.AbstractMap.SimpleImmutableEntry<K,V> createSnapshot() {
            V v = getValidValue();
            if (v == null)
                return null;
            return new jsr166.java.util.AbstractMap.SimpleImmutableEntry<K,V>(key, v);
        }
    ...
    Map.Entry<K,V> doRemoveFirstEntry() {
        for (;;) {
            ...
            if (!n.appendMarker(f) || !b.casNext(n, f))
                findFirst(); // retry
            clearIndexToFirst();
            return new jsr166.java.util.AbstractMap.SimpleImmutableEntry<K,V>(n.key, (V)v);
        }
    }
    ...
    Map.Entry<K,V> doRemoveLastEntry() {
        for (;;) {
            ...
            for (;;) {
                ...
                return new jsr166.java.util.AbstractMap.SimpleImmutableEntry<K,V>(key, (V)v);
            }
        }
    }
     ...
     */
    jsr166.java.util.AbstractMap.SimpleImmutableEntry<K,V> getNear(K key, int rel) {
        for (;;) {
            Node<K,V> n = findNear(key, rel);
            if (n == null)
                return null;
            jsr166.java.util.AbstractMap.SimpleImmutableEntry<K,V> e = n.createSnapshot();
            if (e != null)
                return e;
        }
    }
    ...
    final class EntryIterator extends Iter<Map.Entry<K,V>> {
        public Map.Entry<K,V> next() {
            ...
            V v = nextValue;
            advance();
            return new jsr166.java.util.AbstractMap.SimpleImmutableEntry<K,V>(n.key, v);
        }
    }
     ...
     * @serial include
     */
    static final class SubMap<K,V> extends jsr166.java.util.AbstractMap<K,V>
        ...
        private Map.Entry<K,V> removeLowest() {
            for (;;) {
                ...
                if (v != null)
                    return new jsr166.java.util.AbstractMap.SimpleImmutableEntry<K,V>(k, v);
            }
        }
